...
Escape from Tarkov Remastered é uma coleção cuidadosamente selecionada de mods para SPT, focada em:

* IA avançada
* Progressão equilibrada
* Imersão aprimorada
* Conteúdo lore-friendly
* Atmosfera expandida
* Experiência single-player de longo prazo

O objetivo não é transformar Tarkov em outro jogo, mas expandir a experiência original preservando sua identidade.

---

# Filosofia do Projeto

Este modpack foi criado seguindo alguns princípios:

* Preservar a experiência original do Tarkov
* Melhorar sistemas existentes ao invés de substituí-los
* Expandir conteúdo sem causar power creep excessivo
* Adicionar traders com identidade própria
* Melhorar a atmosfera sem comprometer performance
* Garantir compatibilidade para campanhas longas
...
* Excelente progressão de longo prazo
...
PMC realiza comentários espontâneos durante as raids.

### Raid Review

Resumo detalhado de cada raid.

### WTT Head and Voice Selector

https://forge.sp-tarkov.com/mod/1277/wtt-head-and-voice-selector

Personalização de rosto e voz.
...
Rolagem lateral de traders.

### Continuous Load Ammo

https://forge.sp-tarkov.com/mod/2112/continuous-load-ammo

Carregamento contínuo de munição.

### Manimal's Ammo Loading Animations

https://forge.sp-tarkov.com/mod/2681/manimals-ammo-loading-animations

Animações em primeira pessoa para carregamento de carregadores.

---

# Objetivo Final

Criar a melhor experiência possível de Tarkov single-player:
...
Sem descaracterizar Escape from Tarkov.
